...
command!       -nargs=?  CMakeCompileSource call cmake4vim#CompileCurrentSource(<f-args>)
" }}} Commands "
...
nnoremap <silent> <Plug>(CMakeCompileSource)        :call cmake4vim#CompileSource(<f-args>)<CR>
" }}} Mappings
